...
This package was created with [Cookiecutter](https://github.com/audreyr/cookiecutter) and the [altaf-ali/cookiecutter-pypackage](https://github.com/altaf-ali/cookiecutter-pypackage) project template.
